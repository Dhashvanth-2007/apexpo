...
export default function EditProjectPage() {
      ...
      .then((data) => {
        if (data.success && data.project) {
          ...
          setForm({
            ...
            clientOrConcept: p.clientOrConcept || "Concept Project",
  ...
  if (loading) {
    return <div className="p-12 text-center text-xs text-gray-500 animate-pulse">Loading project details...</div>;
  }
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-extrabold text-white tracking-tight">Edit Project: {form.name}</h2>
          <p className="text-xs text-gray-400">Update project attributes and live publication settings.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-6 rounded-2xl bg-[#0E121E] border border-[#1B2234] space-y-6 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label className="text-gray-400 block mb-1.5 font-bold uppercase tracking-wider text-[11px]">Services Delivered</label>
            <input
              type="text"
              value={form.services}
          ...
          <div>
            <label className="text-gray-400 block mb-1.5 font-bold uppercase tracking-wider text-[11px]">Technologies</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            <label className="text-gray-400 block mb-1.5 font-bold uppercase tracking-wider text-[11px]">Live URL</label>
            <input
              type="url"
              value={form.liveUrl}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            <label className="text-gray-400 block mb-1.5 font-bold uppercase tracking-wider text-[11px]">Technical Solution</label>
            <textarea
              rows={2}
              value={form.solution}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label className="text-gray-400 block mb-1.5 font-bold uppercase tracking-wider text-[11px]">Key Features</label>
            <input
              type="text"
              value={form.features}
        ...
        <div className="flex items-center gap-6 pt-2">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-white font-semibold">Published on public website</span>
          </label>
        </div>
